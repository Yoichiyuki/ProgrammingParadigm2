...
public class chooseMap extends JPanel {
    ...
    public chooseMap(MainGame mainGame) {
        ...
        MapThumbnail map1 = new MapThumbnail(
                "Senate Floor",
                "assets/chooseMaps/4.png"
        );

        MapThumbnail map2 = new MapThumbnail(
                "Malacañang",
                "assets/chooseMaps/5.png"
        );

        MapThumbnail map3 = new MapThumbnail(
                "ICC Exterior",
                "assets/chooseMaps/6.png"
        );

        MapThumbnail map4 = new MapThumbnail(
                "Divisoria",
                "assets/chooseMaps/7.png"
        );
    ...
    private static void drawProportionalImage(
            Graphics2D g2d,
            BufferedImage image,
            int panelWidth,
            int panelHeight
    ...
    class MainDisplayPanel extends JPanel {
        ...
        public void updateDisplay(
            ...
            try {
                ...
                this.currentMapImage = ImageIO.read(
                        new File(imagePath)
                );
        ...
        protected void paintComponent(Graphics g) {
            ...
            String text = "Selected Area: " + currentMapName;
    ...
    class MapThumbnail extends JPanel {
        ...
        public MapThumbnail(
            ...
            try {
                ...
                System.out.println(
                        "Could not load thumbnail image: "
                                + imagePath
                );
            }
            ...
            addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    mainGame.goToCharacterSelection(
                            imagePath
                    );
                }
            });
